...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    SwiftRater.showLaterButton = YES;
    [SwiftRater appLaunched];
    
    //[[TWTRTwitter sharedInstance] startWithConsumerKey:@"hRAX0K6FhMIiwBjcnNVEjgFif" consumerSecret:@"YWB8nFzWFmhTaBxGjmmUD5SqeeDalJKexhiu3kS381PNDxTBpL"];
